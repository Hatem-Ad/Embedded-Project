...
// the objective is write a structer for boot and driver
// Build a solid structer to STM32 firmware
// Write without HAL layer
...
int main(void)
{
  ...
  while (1)
  {
    ...
    HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_12
                                  |GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15, GPIO_PIN_RESET);
    HAL_Delay(70);
